...
>
    ...
    <xsl:template match="/rdf:RDF/sbol:ModuleDefinition">
        ...
        <table class = "table">
            ...
            <xsl:for-each select="sbol:functionalComponent/sbol:FunctionalComponent">
                <xsl:variable name="variable1">
                    <xsl:value-of select="'reactant' = substring( sbol:persistentIdentity/@rdf:resource, string-length(sbol:persistentIdentity/@rdf:resource)-7, 8)"/>
                </xsl:variable>
                <xsl:choose>
        ...
        <table class = "table">
            ...
            <xsl:for-each select="sbol:functionalComponent/sbol:FunctionalComponent">
                <xsl:variable name="variable1">
                    <xsl:value-of select="'product' = substring( sbol:persistentIdentity/@rdf:resource, string-length(sbol:persistentIdentity/@rdf:resource)-6, 7)"/>
                </xsl:variable>
                <xsl:choose>
                    <xsl:when test="$variable1='true'">
                        <xsl:variable name="variable2">
